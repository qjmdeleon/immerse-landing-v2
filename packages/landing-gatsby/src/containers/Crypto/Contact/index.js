            ...
            <Box {...contactForm}>
              ...
              <Box className="contactdes">
                <Text
                  as="span"
                  {...note}
                  content="Become one of the early adopters! . "
                />
...
ContactSection.defaultProps = {
  ...
  title: {
    content: 'Be the first to know when we launch our service!',
  ...
  description: {
    content: 'Sign up to our email list so we can send updates to you.',
    fontSize: '16px',
    fontWeight: '400',
    color: '#525f7f',
    lineHeight: '28px',
