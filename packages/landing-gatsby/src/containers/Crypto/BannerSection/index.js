...
const BannerSection = ({
  ...
  const ButtonGroup = () => (
    <Fragment>
      <Button title="How does it work?" {...btnStyle} />
      <Button
        title="Students get a free month!"
        variant="textButton"
  ...
  const ShareButtonGroup = () => (
    <Fragment>
      ...
      />
      <Button
        title="View Updates on Facebook"
        variant="textButton"
        iconPosition="left"
        ...
        <Box className="row" {...row}>
          <Box className="col" {...col}>
            <FeatureBlock
              title={
                <Heading
                  content="The only kit you need to be at your A+ Game everyday."
                  {...title}
                />
              }
              description={
                <Text
                  content="Up your productivity by a notch -  eliminate distractions
                  and cut-off procrastination. Launching soon!
                  Sign-up now to enjoy exclusive features at launch date. "
                  {...description}
                />
              }
              button={<ButtonGroup />}
