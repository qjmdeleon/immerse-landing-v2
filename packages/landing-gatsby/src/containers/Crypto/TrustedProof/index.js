      ...
      <Container noGutter mobileGutter>
        <Box className="row" {...row}>
          <Box className="colleft" {...col} style={{ flexDirection: 'column' }}>
            <Text
              content="The easiest way to organize your life"
              {...sectionSubTitle}
            />
            <FeatureBlock
              title={
                <Heading content="What is the productivity suite?" {...title} />
              }
              description={
                <Text
                  content="Pop, create and delete important tasks all you need. Immerse does not keep or store any of your personal data."
                  {...description}
                />
              }
            />
