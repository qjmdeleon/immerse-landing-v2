...
import ControlImage from 'common/src/assets/image/crypto/phone-mockup.png';
    ...
    return (
      <div className="countPortion">
        <div className="countSingle">
          75 <span className="countText">Days</span>
        </div>
        <div className="countSingle">
          {hours} <span className="countText">Hours</span>
        </div>
        <div className="countSingle">
          13 <span className="countText">Minutes</span>
        </div>
        <div className="countSingle">
      ...
      <Container>
        <Box className="row" {...row}>
          ...
          <Box className="colright" {...col} {...cardArea}>
            <Text
              content="A mini task-manager for hardworking individuals."
              {...sectionSubTitle}
            />
            <FeatureBlock
              title={
                <Heading content="Take more control of your time." {...title} />
              }
              description={
                <Text
                  content="Our productivity suite includes a task-manager, blitz timer, app-locker, notes and a budget tracker."
                  {...description}
                />
              }
            />
            <Box className="readMoreSection">
              <Text content="Launching Service at...  " {...readMoreTitle} />
